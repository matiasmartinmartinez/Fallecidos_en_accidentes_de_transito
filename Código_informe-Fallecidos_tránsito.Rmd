...
```
  ...
  Para el sexo femenino existe una amplia variación de los datos, ya que pese a corresponder a aproximadamente un 25% de los fallecidos logra poseer un rango intercuartílico mayor al masculino. Los hombres en tanto se concentran a edades menores, con una mediana 6 años menor que la femenina.
...
f %>% count(mes) %>% arrange(desc(n)) %>%
  ggplot( ) + 
  geom_bar(aes(mes, n),fill = "tomato4", stat = "identity", show.legend = F) +
  labs(
    x = "Mes",
