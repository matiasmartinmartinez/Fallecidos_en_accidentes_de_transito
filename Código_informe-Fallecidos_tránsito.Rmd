...
datos<- datos %>% mutate(lon=(x*-1/10000),lat=(y*-1/100000)) %>% select(-x,-y)
```
...
ggmap(get_googlemap(center="uruguay",zoom=7)) + geom_point(data=datos,aes(lon,lat), color="red", alpha = .5,size=2645) + facet_wrap(~jur)
