...
datos %>% dplyr::count(tipo.sin, jur) %>% mutate(tipo.sin=ifelse(n <= 60,"OTROS",tipo.sin) ) %>% ggplot() + geom_mosaic(aes(
    weight = n,
    ...
    scale_fill_manual(values = c("cornflowerblue", "seagreen3")) + theme(axis.title = element_text(colour="grey24"))
```
