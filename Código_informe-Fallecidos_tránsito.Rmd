...
Adiccional a las mismas y con el objetivo de un análisis con mayor justicia en cuanto a las proporciones de fallecidos por departamento, se adiciona en el transcurso del estudio los valores de la población correspondientes a cada departamento del Uruguay. Los mismos son extraídos del censo  realizado en el año 2011 por el Instituto Nacional de Estadística y pretenden el uso de posteriores tasas que representen con mayor claridad e información que únicamente las frecuencias absolutas por departamento.
