...
ggplot() + geom_polygon(data = uystates_df, aes(x = long, y = lat, group = group, fill =n), color = "black", size = 0.25)+ theme(aspect.ratio = 1) + labs(fill = "Cantidad",x=NULL,y=NULL,title="Gráfico de mapas: cantidad de fallecidos por departamento") + theme_opts
