...
2- Los fallecidos en rol conductor poseen una frecuencia absoluta de entre 280 a 370 aproximadamente, en contraste con las frecuencias registrada en peatones y pasajeros, los cuales presentan valores aproximados a 100 fallecidos por año con leves desvíos a medida que pasan los mismos.
...
Para la relación entre el vehículo del fallecido respecto al rol del mismo se encontra una alta cantidad de fallecidos en conductores de motos y autos, respectivamente. Pero al momento de observar la proporción de fallecimientos en rol de conductor, los fallecimientos en bicicleta prevalecen sobre la de motos y autos.
...
7- La mayoría de los fallecimientos en siniestros de tránsito se dan en la zona metropolitana, conformada por los departamentos de Montevideo, Maldonado, Canelones y San José. Los mismos son los únicos en superar la media de fallecidos en todo el país y denotan la fuerte conglomeración allí existente.
...
8- Llegado el análisis de tendencias en las fechas de los accidentes fatales, se percatan frecuencias absolutas superiores en los años 2013 y 2014, para luego decrecer hasta el año 2016 y finalmente retomar su crecimiento en 2017 donde presenta su valor mas alto en el mes de diciembre.
