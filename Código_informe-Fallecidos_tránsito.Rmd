...
La curva azul corresponde al diagrama de Pareto y representa la densidad acumulada hasta *x* día.
...
```{r,fig.cap="Diagrama térmico: frecuencia absoluta de fallecidos según día y hora"}
