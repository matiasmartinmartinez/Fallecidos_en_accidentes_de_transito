...
paquetes.a.utilizar<- c("tidyverse", "ggmosaic","ggthemes", "plotly", "ggmap", "raster", "rgdal")
...
ggplotly(
  datos %>% count(a)  %>% ggplot(aes(reorder(a, -n), n)) + 
...
ggplotly(
  datos %>% ggplot(aes(sexo, edad)) + 
    ...
    labs(
      x =  "Sexo",
      y = "Edad en años",
      title = "Diagrama de caja: edad según sexo") +
    theme(plot.title =
            element_text(
              size = 16,
              colour = "grey19")) +
