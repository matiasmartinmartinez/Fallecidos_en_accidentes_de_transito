...
### Dirección
```{r,warning=FALSE}
 #m<-map(regions = "uruguay", fill=T, add=F)
 #m<-data.frame(x=m$x,y=m$y)

#ggplot( m ,aes(x , y ))+  geom_polygon() +
  coord_map()
...
#library(rgdal)
#download.file("http://ine.gub.uy/documents/10181/18006/Mapas+Vectoriales+a%C3%B1o+2004/6f41de7b-95ca-4287-b697-8e4b66513464", "mapa.zip")
#unzip("mapa.zip")
...
map + geom_point(data=coord, aes(x,y), color="red")
```
