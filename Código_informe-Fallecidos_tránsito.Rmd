...
datos %>% filter(vehi=="PEATON")  %>%
  ...
  count(a,otro.vehi,sexo) %>% 
   ...
   geom_line(alpha=0.6,
     ...
     show.legend = T,
     cex=1.1 ) +
  geom_point()+ theme_minimal()+facet_wrap(~sexo)
...
Los accidentes se concentran de 16:00 a 20:00 horas, aumentando paulativamente a medida se acercan los días correspondientes al fin de semana.
