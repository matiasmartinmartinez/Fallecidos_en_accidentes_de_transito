...
Para este período trabajado no parece variar significativamente las frecuencias absolutas de peaton y pasajero, tiende a mantenerse en el tiempo observando que solamente representan 80 casos al año, mientras que los fallecidos en rol de conductores se puede notar un breve decenso ya que en 2017 obvieron mas fallecidos que el año sucesor.
...
```
 ...
 Aunque el mes de diciembre tiene una cantidad de fallecidos mayor, no existe una clara tendencia, salvo el mes de mayo donde los accidentes fatales tienen la frecuencia absoluta de menor valor.
